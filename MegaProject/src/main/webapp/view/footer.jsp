...
<footer>
    <div id="container bg-secondary">
         <div id="part1">
             <div id="companyinfo"> <a id="sitelink" href="#">Recruiters</a>
                 <p id="title">Solution for Teams</p>
                 <p id="detail">Business Operation Manager, Team leaders and Human Resource</p>
             </div>
             <div id="explore">
                 <p id="txt1">Explore</p> <a class="link" href="#">Home</a> <a class="link" href="#">Community</a> <a class="link" href="#">Snippet</a> <a class="link" href="#">Careers</a>
             </div>
             <div id="visit">
                 <p id="txt2">Visit</p>
         ...
         <div id="part2">
             <p id="txt6"><i class="material-icons tiny  text-align-center">copyright</i>copyright 2019 BBbootstrap - All right reserved</p>
         </div>
     </div>
