	...
	<div class="alert alert-success">Resgistration unSuccess</div>
          ...
          <!-- <div class="top-row"> -->
            <div class="field-wrap">
              ...
              <input type="text" name="username" placeholder="Enter fullname"  pattern="[A-Za-z.\s]{1,}"required autocomplete="off" title="Fullname should only contain letters. e.g. john" />
            </div>
          ...
          <div class="field-wrap">
           ...
           <div class="field-wrap"> -->
              ...
              <input type="text" name="mobile" placeholder="Enter mobileno" Pattern= "[789][0-9]{9}" required autocomplete="off" title="enter valid mobile no." />
            </div>
